...
void	print_column1(int line, int current_player_id, Cell *all_cells)
{
	...
	{
		/* Cell Coordinate 11 */
		if (!(all_cells + 0)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 0)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 0)->stone_in_cell
	...
	{
		/* Cell Coordinate 12 */
		if (!(all_cells + 3)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 3)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 3)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
	...
	{
		/* Cell Coordinate 13 */
		if (!(all_cells + 6)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 6)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 6)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
	...
	{
		/* Cell Coordinate 14 */
		if (!(all_cells + 9)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 9)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 9)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
	...
	{
		/* Cell Coordinate 17 */
		if (!(all_cells + 14)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 14)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 14)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
	...
	{
		/* Cell Coordinate 18 */
		if (!(all_cells + 17)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 17)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 17)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
...
void	print_column3(int line, int current_player_id, Cell *all_cells)
{
	...
	{
		/* Cell Coordinate 31 */
		if (!(all_cells + 2)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 2)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 2)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
	...
	{
		/* Cell Coordinate 32 */
		if (!(all_cells + 5)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 5)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 5)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
	...
	{
		/* Cell Coordinate 33 */
		if (!(all_cells + 8)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 8)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 8)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
	...
	{
		/* Cell Coordinate 34 */
		if (!(all_cells + 11)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 11)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 11)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
	...
	{
		/* Cell Coordinate 37 */
		if (!(all_cells + 16)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 16)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 16)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
	...
	{
		/* Cell Coordinate 38 */
		if (!(all_cells + 19)->stone_in_cell)
			id = 0;
		else
		{
			id = (all_cells + 19)->stone_in_cell->id;
			stone_belongs_to_current_player = (all_cells + 19)->stone_in_cell
				->player_id == current_player_id ? 1 : 0;
		}
